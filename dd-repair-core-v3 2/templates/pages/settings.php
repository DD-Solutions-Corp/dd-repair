...
$initial = mb_strtoupper( mb_substr( $user->display_name ?? 'U', 0, 1, 'UTF-8' ) );
...
<div id="page-settings" class="page active">
  ...
  <div class="card" style="margin-bottom:16px;">
    <div style="display:flex;align-items:center;gap:16px;margin-bottom:16px;">
      ...
      <div style="flex:1;">
        <div style="font-size:18px;font-weight:600;color:#1e293b;margin-bottom:4px;"><?php echo esc_html($user->display_name); ?></div>
